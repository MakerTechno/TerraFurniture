...
public class TFRecipeProvider extends AbstractRecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput recipeOutput, HolderLookup.Provider holderLookup) {
        ...
        recipe(recipeOutput, TFBlocks.GLASS_CHAIR.toStack(), ShapedRecipePattern.of(Map.of(
                'G', Ingredient.of(Items.GLASS)
        ), List.of(
                "G ",
                "GG"
        )), 0.1F, 200);
        recipe(recipeOutput, TFBlocks.GLASS_TOILET.toStack(), ShapedRecipePattern.of(Map.of(
                'G', Ingredient.of(Items.GLASS)
        ), List.of(
                "GG ",
                " GG",
        ...
        recipe(recipeOutput, TFBlocks.GLASS_TABLE.toStack(), ShapedRecipePattern.of(Map.of(
                'G', Ingredient.of(Items.GLASS),
        ...
        recipe(recipeOutput, TFBlocks.GLASS_SOFA.toStack(), ShapedRecipePattern.of(Map.of(
                'G', Ingredient.of(Items.GLASS),
        ...
        recipe(recipeOutput, TFBlocks.GLASS_CHANDELIER.toStack(), ShapedRecipePattern.of(Map.of(
                'G', Ingredient.of(Items.GLASS),
        ...
        recipe(recipeOutput, TFBlocks.GLASS_SINK.toStack(), ShapedRecipePattern.of(Map.of(
                'G', Ingredient.of(Items.GLASS),
        ...
        recipe(recipeOutput, TFBlocks.GLASS_CANDLE.toStack(), ShapedRecipePattern.of(Map.of(
                'G', Ingredient.of(Items.GLASS),
        ...
        recipe(recipeOutput, TFBlocks.GLASS_LANTERN.toStack(), ShapedRecipePattern.of(Map.of(
                'G', Ingredient.of(Items.GLASS),
                'A', Ingredient.of(Items.TORCH)
        ), List.of(
                " G ",
        ...
        recipe(recipeOutput, TFBlocks.GLASS_LAMP.toStack(), ShapedRecipePattern.of(Map.of(
                'G', Ingredient.of(Items.GLASS),
                'A', Ingredient.of(Items.TORCH)
        ), List.of(
                " A ",
        ...
        recipe(recipeOutput, TFBlocks.GLASS_CANDELABRAS.toStack(), ShapedRecipePattern.of(Map.of(
                'G', Ingredient.of(Items.GLASS),
