...
public class OneLegTableGeoModel extends GeoModel<OneLegTableBlock.BEntity> {
    ...
    public static ModelVariant variant(OneLegTableBlock.BEntity animatable) {
        ...
        return switch (mask) {
            case 1 -> new ModelVariant("oneside", 1);
            case 2 -> new ModelVariant("oneside", 0);
            case 3 -> new ModelVariant("corner", 1);
            case 4 -> new ModelVariant("oneside", 3);
            case 5 -> new ModelVariant("straight", 1);
            case 6 -> new ModelVariant("corner", 0);
            case 7 -> new ModelVariant("side", 0);
            case 8 -> new ModelVariant("oneside", 2);
            case 9 -> new ModelVariant("corner", 2);
            case 10 -> new ModelVariant("straight", 0);
            case 11 -> new ModelVariant("side", 1);
            case 12 -> new ModelVariant("corner", 3);
            case 13 -> new ModelVariant("side", 2);
            case 14 -> new ModelVariant("side", 3);
