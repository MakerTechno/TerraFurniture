...
public class ChairStraightBlock extends ChairBlock {
    ...
    public static class ChairStraightBE extends ChairBE implements GeoBlockEntity {
        private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

        public ChairStraightBE(BlockPos pos, BlockState blockState) {
            super(TFBlocks.CHAIR_STRAIGHT_ENTITY.get(), pos, blockState);
        }
    ...
    public static class Item extends BlockItem implements GeoItem {
        ...
        public Item(ChairStraightBlock pBlock) {
