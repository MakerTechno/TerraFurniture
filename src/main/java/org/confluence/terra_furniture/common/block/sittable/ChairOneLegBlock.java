...
public class ChairOneLegBlock extends ChairBlock {
    ...
    public static class ChairOneLegBE extends ChairBE implements GeoBlockEntity {
        private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

        public ChairOneLegBE(BlockPos pos, BlockState blockState) {
            super(TFBlocks.CHAIR_ONELEG_ENTITY.get(), pos, blockState);
        }
    ...
    public static class Item extends BlockItem implements GeoItem {
        ...
        public Item(ChairOneLegBlock pBlock) {
