...
public class TFLanternBlock extends SwitchableLightBlock{
    ...
    public static final MapCodec<TFLanternBlock> CODEC;
    ...
    public @NotNull MapCodec<? extends TFLanternBlock> codec() {
        return CODEC;
    }
    static {
        CODEC = RecordCodecBuilder.mapCodec((p_308842_) -> p_308842_.group(PARTICLE_OPTIONS_FIELD.forGetter((p_304762_) -> p_304762_.flameParticle), propertiesCodec()).apply(p_308842_, TFLanternBlock::new));
    }
}
