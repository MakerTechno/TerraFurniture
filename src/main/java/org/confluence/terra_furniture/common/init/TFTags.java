...
public class TFTags {
    ...
    public static final TagKey<Block> LIBRARIAN_FURNITURE = register("librarian_furniture");
    ...
    public static final TagKey<Block> BOULDER_FURNITURE = register("boulder_furniture");
    ...
    public static final TagKey<Block> SNOW_FURNITURE = register("snow_furniture");
    ...
    public static final TagKey<Block> AETHERIUM_FURNITURE = register("aetherium_furniture");
    ...
    public static final TagKey<Block> CRIMTAIN_FURNITURE = register("crimtain_furniture");
    public static final TagKey<Block> CRYSTAL_FURNITURE = register("crystal_furniture");
    public static final TagKey<Block> DEMONITE_FURNITURE = register("demonite_furniture");
    public static final TagKey<Block> DYNASTY_FURNITURE = register("dynasty_furniture");
    public static final TagKey<Block> EASTER_FURNITURE = register("easter_furniture");
    public static final TagKey<Block> EBONWOOD_FURNITURE = register("ebonwood_furniture");
    public static final TagKey<Block> FALLEN_STAR_FURNITURE = register("fallen_star_furniture");
    public static final TagKey<Block> FLINX_FUR_FURNITURE = register("flinx_fur_furniture");
    public static final TagKey<Block> FORBIDDEN_FURNITURE = register("forbidden_furniture");
    public static final TagKey<Block> GRANITE_FURNITURE = register("granite_furniture");
    public static final TagKey<Block> HALLOWED_FURNITURE = register("hallowed_furniture");
    ...
    public static final TagKey<Block> OFFICE_FURNITURE = register("office_furniture");
    ...
    public static final TagKey<Block> SPIKE_FURNITURE = register("spike_furniture");
